...
DATA_DIR = Path("/Users/aleyaley/Desktop/AB/model/sequence/class_weight/data/extra_features")
...
model = BiLSTMModel(input_size=X_train.shape[2], hidden_size=HIDDEN_SIZE).to(DEVICE)
