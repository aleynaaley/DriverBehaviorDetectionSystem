...
# AYARLAR
# =========================================================
BASE_DIR = Path(__file__).resolve().parent                 # .../balancing/models/xgboost
...
# =========================================================
# MODEL
# Balanced veri kullandığımız için ekstra class weight vermiyoruz
# =========================================================
model = XGBClassifier(
    n_estimators=300,
    max_depth=6,
...
plt.title("XGBoost - Confusion Matrix (Balanced Train)")
plt.tight_layout()
